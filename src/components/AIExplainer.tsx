...
const explanations: Record<
  string,
  { summary: string; complexity: string; space: string; steps: string[] }
> = {
  "bubble-sort": {
    summary:
      'Bubble Sort repeatedly steps through the list, compares adjacent elements and swaps them if they are in the wrong order. The largest values "bubble up" to the end.',
    complexity: "O(n²)",
    space: "O(1)",
    steps: [
  ...
  "quick-sort": {
    summary:
      "Quick Sort picks a pivot element and partitions the array so all smaller elements are left of the pivot and larger ones are right. Then recursively sorts each side.",
    complexity: "O(n log n) avg",
    space: "O(log n)",
    steps: [
      "Pick a pivot element",
      "Partition: small left, large right",
  ...
  "merge-sort": {
    summary:
      "Merge Sort divides the array into two halves, recursively sorts each half, then merges them back together in sorted order.",
  ...
  "binary-search": {
    summary:
      "Binary Search works on sorted arrays. It repeatedly halves the search space by comparing the target with the middle element.",
    complexity: "O(log n)",
    space: "O(1)",
    steps: [
  ...
  "linear-search": {
    summary:
      "Linear Search checks every element one by one from start to end until it finds the target or reaches the end of the array.",
    complexity: "O(n)",
    space: "O(1)",
    steps: [
      "Start at index 0",
  ...
  bfs: {
    summary:
      "Breadth-First Search explores a graph level by level. It uses a queue to visit all neighbors of a node before moving deeper.",
    complexity: "O(V + E)",
    space: "O(V)",
    steps: [
      "Start at root node",
  ...
  dfs: {
    summary:
      "Depth-First Search explores as far as possible along each branch before backtracking. It uses a stack (or recursion) to track the path.",
    complexity: "O(V + E)",
    space: "O(V)",
    steps: [
      "Start at root node",
      "Go deep into first branch",
  ...
  "linked-list": {
    summary:
      "A Linked List stores elements in nodes. Each node holds a value and a pointer to the next node. It allows fast insertions but slow random access.",
    complexity: "Search: O(n)",
    space: "O(n)",
    steps: [
      "Each node has value + next pointer",
      "Traverse by following pointers",
  ...
  "graph-traversal": {
    summary:
      "Graph Traversal visits all vertices and edges. Use BFS for shortest paths, DFS for cycle detection, topological sort, or exploring all paths.",
    complexity: "O(V + E)",
    space: "O(V)",
    steps: [
